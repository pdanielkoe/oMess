...
;(function () {
  var languages = {
    ...
    en: {
      y: function (c) { return 'y' + (c !== 1 ? 's' : '') },
      mo: function (c) { return 'm' + (c !== 1 ? 's' : '') },
      w: function (c) { return 'w' + (c !== 1 ? 's' : '') },
      d: function (c) { return 'd' + (c !== 1 ? 's' : '') },
      h: function (c) { return 'h' + (c !== 1 ? 's' : '') },
      m: function (c) { return 'm' + (c !== 1 ? 's' : '') },
      s: function (c) { return 's' + (c !== 1 ? 's' : '') },
      ms: function (c) { return 'ms' + (c !== 1 ? 's' : '') },
      decimal: '.'
    },
    es: {
